; inherits: gotmpl
; NOTE: This should make Helm template highlighting inherit gotmpl syntax.
...
; Builtin Helm/Sprig template functions.
(function_call
  ...
  (#any-of? @function.builtin
    ...
    "mustLast" "initial" "mustInitial" "append" "mustAppend" "prepend" "concat" "reverse" "mustReverse"
    "uniq" "mustUniq" "without" "mustWithout" "has" "mustHas" "compact" "mustCompact" "index"
    "slice" "mustSlice" "until" "untilStep" "seq" "add" "add1" "sub" "div" "mod" "mul" "max"
    "min" "len" "addf" "add1f" "subf" "divf" "mulf" "maxf" "minf" "floor" "ceil" "round"
    "getHostByName" "base" "dir" "clean" "ext" "isAbs" "kindOf" "kindIs" "typeOf" "typeIs"
    "typeIsLike" "deepequal" "semver" "semverCompare" "urlParse" "urlJoin" "urlquery" "lookup"
    "include"))

; Top-level Helm objects, e.g. {{ .Values.image.repository }}.
(selector_expression
  operand: (field
...
; Top-level Helm objects through root, e.g. {{ $.Values.image.repository }}.
(selector_expression
  operand: (variable)
