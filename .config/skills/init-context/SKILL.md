---
name: init-context
description: Create or update a repo `AGENTS.md` file with cautious implementation guidance. Use when the user wants to scaffold agent instructions around explicit assumptions, simplicity-first execution, surgical diffs, and verifiable success criteria.
---
...
2. If `AGENTS.md` already exists, read it before editing.
...
- appending this guidance as a new section when there is no overlap
- replacing an older equivalent section when the intent is clearly the same
...
- The file contains all four major sections:
  - Think Before Coding
  - Simplicity First
  - Surgical Changes
